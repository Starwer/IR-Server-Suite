  ...
  public static class IrssLog
  {
    ...
    public static void Open(string fileName)
    {
      ...
      if (File.Exists(filePath))
      {
        ...
        {
            if (_logLevel >= Level.Error) Logger.Error(ex);
        }
      }
    ...
    {
        if (_logLevel >= Level.Info)  Logger.Info("Log Closed");
    }
    ...
    {
        if (_logLevel >= Level.Error) Logger.Error(format, args);
    }
    ...
    {
        if (_logLevel >= Level.Error) Logger.Error(format, ex, args);
    }
    ...
    {
        if (_logLevel >= Level.Warn) Logger.Warn(format, args);
    }
    ...
    {
        if (_logLevel >= Level.Warn) Logger.Warn(format, ex, args);
    }
    ...
    {
        if (_logLevel >= Level.Info) Logger.Info(format, args);
    }
    ...
    {
        if (_logLevel >= Level.Info) Logger.Info(format, ex, args);
    }
    ...
    {
        if (_logLevel >= Level.Debug) Logger.Debug(format, args);
    }
    ...
    {
        if (_logLevel >= Level.Debug) Logger.Debug(format, ex, args);
    }
